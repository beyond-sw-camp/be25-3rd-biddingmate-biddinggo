<template>
  <div class="purchase-modal-overlay" @click="$emit('close')">
    <section v-if="mode === 'detail'" class="purchase-modal purchase-modal--detail" @click.stop>
      <button class="purchase-modal__close" type="button" @click="$emit('close')">×</button>

      <div class="purchase-modal__scroll modal-scroll">
          ...
          <div class="purchase-info-block">
            ...
            <div v-if="item.shippingAddress" class="purchase-info-card">
              ...
              <template v-if="item.shippingAddress.zip">
                <p class="purchase-info-card__label">주소</p>
    ...
    <section v-else-if="mode === 'shipping-form'" class="purchase-modal purchase-modal--form" @click.stop>
      <div class="purchase-modal__scroll modal-scroll">
        <div class="purchase-modal__head">
          <h2>배송지 정보 등록</h2>
          <button class="purchase-modal__close purchase-modal__close--inline" type="button" @click="$emit('close')">×</button>
        </div>
        ...
        <button class="primary-button purchase-form__submit" type="button" @click="$emit('save-address')">배송지 정보 등록</button>
      </div>
    </section>

    <section v-else-if="mode === 'address-book'" class="purchase-modal purchase-modal--address-book" @click.stop>
      <button class="purchase-modal__close" type="button" @click="$emit('back', 'shipping-form')">×</button>
